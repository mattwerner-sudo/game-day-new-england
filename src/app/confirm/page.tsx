...
export default async function ConfirmPage({
  ...
  if (fan.confirmedAt && !fan.unsubscribedAt) {
    return (
      <div className="min-h-screen bg-zinc-50 dark:bg-black">
        <main className="mx-auto max-w-xl px-4 py-10 text-center">
          <HomeLink />
          <h1 className="mt-4 text-2xl font-bold text-zinc-950 dark:text-zinc-50">Already confirmed</h1>
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <main className="mx-auto max-w-xl px-4 py-10 text-center">
        <HomeLink />
        <h1 className="mt-4 text-2xl font-bold text-zinc-950 dark:text-zinc-50">Confirm your email</h1>
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
