...
export const metadata: Metadata = {
  title: "All Leagues | Game Day New England",
  description: "Every New England college sports conference covered by Game Day New England, with a full schedule for each.",
};
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <main className="mx-auto max-w-2xl px-4 py-10">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          {leagues.length} conferences covered. Pick one for its full schedule.
        </p>
