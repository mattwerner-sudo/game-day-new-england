...
export const SCHOOLS_SEED = [
  ...
  // Remaining 12 of 20 real PrestoSports schools confirmed NOT WAF-blocked (checked directly
  // this session - all returned real content-type:text/calendar responses to a plain fetch of
  // <domain>/composite?print=ics). The other 5 (Framingham State, Salem State, Westfield State,
  // Mass Maritime, Worcester State) remain confirmed WAF-blocked, not added yet.
  {
    ...
    lat: 41.3382,
    lng: -72.908,
    websiteUrl: "https://albertusfalcons.com",
    cmsPlatform: "presto",
  },
  {
    name: "Elms College",
    ...
    lat: 42.1487,
    lng: -72.5851,
    websiteUrl: "https://ecblazers.com",
    cmsPlatform: "presto",
  },
  {
    ...
    lat: 42.337,
    lng: -71.2092,
    websiteUrl: "https://laserpride.lasell.edu",
    cmsPlatform: "presto",
  },
  {
    name: "Regis College",
    ...
    lat: 42.3709,
    lng: -71.2967,
    websiteUrl: "https://goregispride.com",
    cmsPlatform: "presto",
  },
  {
    ...
    lat: 41.7576,
    lng: -72.7423,
    websiteUrl: "https://usjbluejays.com",
    cmsPlatform: "presto",
  },
  {
    ...
    lat: 42.2571,
    lng: -72.5757,
    websiteUrl: "https://athletics.mtholyoke.edu",
    cmsPlatform: "presto",
  },
  {
    name: "Curry College",
    ...
    lat: 42.2251,
    lng: -71.0826,
    websiteUrl: "https://curryathletics.com",
    cmsPlatform: "presto",
  },
  {
  ...
  },
  {
    ...
    lat: 42.3588,
    lng: -71.0617,
    websiteUrl: "https://gosuffolkrams.com",
    cmsPlatform: "presto",
  },
  {
    ...
    lat: 42.3398,
    lng: -71.0952,
    websiteUrl: "https://wentworthathletics.com",
    cmsPlatform: "presto",
  },
  {
    ...
    lat: 42.3811,
    lng: -71.1215,
    websiteUrl: "https://lesleyathletics.com",
    cmsPlatform: "presto",
  },
  {
    name: "Vermont State University-Johnson",
    conference: "North Atlantic Conference",
    division: "D3",
    city: "Johnson",
    state: "VT",
